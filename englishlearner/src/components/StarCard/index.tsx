...
export default function StarCard() {
      ...
      <>
        {isCounting ? (
          ...
          <div className="flex pb-0 pt-6">
            <button
              className="rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500 px-6 py-2 text-lg text-white shadow-lg shadow-indigo-500/30 transition-all duration-300 hover:shadow-xl hover:scale-105 focus:outline-none"
              type="button"
  ...
  return (
    ...
    >
      <div className="fixed right-1 top-4 flex w-150 flex-col items-center justify-evenly rounded-3xl bg-white/80 p-12 shadow-2xl backdrop-blur-xl dark:bg-gray-800/80">
        ...
        <span className="pb-4 text-xl text-gray-600 dark:text-gray-50">
          坚持练习，提高语言能力。将 <span className="text-indigo-600">「English Learner」</span>保存到收藏夹，永不迷失！
        </span>
        {content}
      </div>
    </Transition>
