...
import { exportDictionary } from '@/utils/dictExport'
      ...
      <div className="text relative flex h-40 flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={exporting}
            className="my-btn-primary h-8 px-4 text-sm shadow transition hover:bg-indigo-600 disabled:opacity-50"
          >
            {exporting ? '导出中...' : '导出词库'}
          </button>
        </div>
