...
const internationalExam: DictionaryResource[] = [
  ...
  },
  {
    id: 'IELTS-oral-900',
    name: '雅思口语 900 beta版',
    description: '雅思口语 900 句, 需在设置中调小英语字体',
    category: '国际考试',
    tags: ['IELTS'],
...
// 短语学习
const phrasesDicts: DictionaryResource[] = [
  {
    id: 'phrases-beginner',
    name: '常用短语（初级）',
    description: '基础常用英语短语，适合入门学习者',
    category: '短语学习',
    tags: ['短语', '初级'],
    url: '/dicts/CommonPhrases_Beginner.json',
    length: 240,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'phrases-intermediate',
    name: '常用短语（中级）',
    description: '中级英语常用短语，提升表达能力',
    category: '短语学习',
    tags: ['短语', '中级'],
    url: '/dicts/CommonPhrases_Intermediate.json',
    length: 350,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'phrases-advanced',
    name: '常用短语（高级）',
    description: '高级英语短语与习语，包含正式表达和复杂搭配',
    category: '短语学习',
    tags: ['短语', '高级'],
    url: '/dicts/CommonPhrases_Advanced.json',
    length: 630,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'phrases-daily-spoken',
    name: '日常口语短语',
    description: '英语口语高频短语，聊天、生活、社交必备',
    category: '短语学习',
    tags: ['短语', '口语'],
    url: '/dicts/DailySpokenPhrases.json',
    length: 330,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'phrases-school',
    name: '中小学生常用短语',
    description: '中小学英语教材核心短语，适合学生打好基础',
    category: '短语学习',
    tags: ['短语', '中小学'],
    url: '/dicts/SchoolPhrases.json',
    length: 339,
    language: 'en',
    languageCategory: 'en',
  },
...
// 句子学习
const sentencesDicts: DictionaryResource[] = [
  {
    id: 'daily-sentences',
    name: '日常对话句子',
    description: '日常生活高频英语句子，实用口语必备',
    category: '句子学习',
    tags: ['句子', '日常对话'],
    url: '/dicts/DailySentences.json',
    length: 180,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'classic-sentence-patterns',
    name: '经典句型',
    description: '英语经典句型与语法句式，举一反三',
    category: '句子学习',
    tags: ['句子', '句型', '语法'],
    url: '/dicts/ClassicSentencePatterns.json',
    length: 180,
    language: 'en',
    languageCategory: 'en',
  },
